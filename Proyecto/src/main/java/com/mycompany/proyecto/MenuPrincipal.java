...
public class MenuPrincipal extends JFrame {
    ...
    public MenuPrincipal() {
        ...
        panelFondo.setLayout(new GridBagLayout()); // Centrar botones sobre la imagen
        ...
        // Añadir botones con espaciado usando GridBagConstraints
    ...
    // Método para crear botones con estilo transparente
    private JButton crearBoton(String texto) {
        ...
        boton.setBackground(new Color(0, 0, 0, 150)); // Negro semi-transparente
